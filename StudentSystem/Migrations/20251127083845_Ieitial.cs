...
{
    /// <inheritdoc />
    public partial class Ieitial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCourses", x => new { x.CourseEnrollmentsCourseId, x.StudentsEnrolledStudentId });
                    table.ForeignKey(
                        name: "FK_StudentCourses_Courses_CourseEnrollmentsCourseId",
                        column: x => x.CourseEnrollmentsCourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentCourses_Students_StudentsEnrolledStudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentCourses_StudentsEnrolledStudentId",
